...
insert into public.content_assets (
  ...
  'doc-107',
  '1Cell.Ai Cross-Functional Collaboration & Standard Operating Guidelines',
  'Company-wide operating manual and standard operating guidelines for seamless cross-functional content sharing and asset creation across Marketing, Sales, Medical, Scientific, and Leadership teams.',
  'company-assets',
  'Corporate',
  'company',
  'Others',
  ...
  'marketing',
  'all',
  'https://ocdipl.sharepoint.com/sites/1Cell.AiMarketingSite/Shared%20Documents/Corporate/1Cell_CrossFunctional_Collaboration_Guidelines.pdf',
  'Shared Documents/Corporate',
  'Cross-Functional Operations',
  'team@1cell.ai',
  '2026-09-08T00:00:00.000Z',
  '2026-09-08T00:00:00.000Z',
  FALSE,
  '{"size": "3.5 MB", "downloadCount": 110, "viewCount": 320, "isPinned": true, "isTrending": true, "year": "2026"}'::jsonb
...
insert into public.content_assets (
  ...
  'doc-101',
  '1Cell.Ai Corporate Overview & Pitch Deck',
  'Official corporate pitch deck articulating 1Cell.Ai''s mission to impact 1,000,000 cancer patients, our single-cell multi-omic liquid biopsy platforms, AI bioinformatics pipeline, and global clinical validation milestones.',
  'company-assets',
  'Corporate',
  'company',
  'Presentation',
  ...
  'marketing',
  'all',
  'https://ocdipl.sharepoint.com/sites/1Cell.AiMarketingSite/Shared%20Documents/Corporate/1Cell_Corporate_PitchDeck.pdf',
  'Shared Documents/Corporate',
  ...
  '2026-09-08T00:00:00.000Z',
  FALSE,
  '{"size": "6.4 MB", "downloadCount": 340, "viewCount": 890, "isPinned": true, "isTrending": true, "year": "2026"}'::jsonb
) on conflict (id) do update set
  title = excluded.title,
  description = excluded.description,
  sharepoint_url = excluded.sharepoint_url,
...
insert into public.content_assets (
  ...
  'doc-102',
  '1Cell.Ai Brand Identity & Design Guidelines Manual v3.0',
  'Comprehensive brand guidelines establishing official logo usage, primary & reverse palettes, typography hierarchy (Outfit & Source Serif 4), iconography standards, and tone of voice.',
  'company-assets',
  'Marketing',
  'company',
  'Brand Asset',
  ...
  'marketing',
  'all',
  'https://ocdipl.sharepoint.com/sites/1Cell.AiMarketingSite/Shared%20Documents/Corporate/1Cell_Brand_Guidelines_v3.0.pdf',
  'Shared Documents/Corporate/Branding',
  'Brand Operations',
  'team@1cell.ai',
  '2026-02-01T00:00:00.000Z',
  '2026-09-08T00:00:00.000Z',
  FALSE,
  '{"size": "12.8 MB", "downloadCount": 410, "viewCount": 1120, "isPinned": true, "isTrending": true, "year": "2026"}'::jsonb
) on conflict (id) do update set
  title = excluded.title,
  description = excluded.description,
  sharepoint_url = excluded.sharepoint_url,
...
insert into public.content_assets (
  ...
  'doc-103',
  '1Cell.Ai Company Profile & Executive One-Pager',
  'Executive corporate profile summarizing 1Cell.Ai''s Cupertino headquarters, leadership team under CEO Mohan Uttarwar, multi-patent portfolio, and global hospital laboratory partnerships.',
  'company-assets',
  'Corporate',
  'company',
  'One Pager',
  ...
  'marketing',
  'all',
  'https://ocdipl.sharepoint.com/sites/1Cell.AiMarketingSite/Shared%20Documents/Corporate/1Cell_Company_Profile.pdf',
  'Shared Documents/Corporate',
  ...
  '2026-09-08T00:00:00.000Z',
  FALSE,
  '{"size": "1.9 MB", "downloadCount": 260, "viewCount": 640, "isPinned": false, "isTrending": false, "year": "2026"}'::jsonb
) on conflict (id) do update set
  title = excluded.title,
  description = excluded.description,
  sharepoint_url = excluded.sharepoint_url,
...
insert into public.content_assets (
  ...
  'doc-104',
  '1Cell.Ai Master Clinical & Commercial Services Agreement (MSA)',
  'Standard enterprise master services agreement template defining diagnostic test ordering protocols, chain-of-custody specimen governance, HIPAA/GDPR compliance, and IP protection.',
  'company-assets',
  'Corporate',
  'company',
  'Others',
  ...
  'marketing',
  'all',
  'https://ocdipl.sharepoint.com/sites/1Cell.AiMarketingSite/Shared%20Documents/Corporate/1Cell_Master_Services_Agreement.pdf',
  'Shared Documents/Corporate/Legal',
  'Legal & Compliance',
  'team@1cell.ai',
  '2026-03-05T00:00:00.000Z',
  '2026-09-08T00:00:00.000Z',
  FALSE,
  '{"size": "2.1 MB", "downloadCount": 180, "viewCount": 490, "isPinned": false, "isTrending": false, "year": "2026"}'::jsonb
) on conflict (id) do update set
  title = excluded.title,
  description = excluded.description,
  sharepoint_url = excluded.sharepoint_url,
...
insert into public.content_assets (
  ...
  'doc-105',
  '1Cell.Ai Laboratory Quality Manual & CAP/CLIA Accreditations',
  'Comprehensive quality management system (QMS) documentation detailing clinical validation standards, proficiency testing protocols, and standard operating procedures (SOPs).',
  'company-assets',
  'Scientific',
  'company',
  'Whitepaper',
  ...
  'scientific',
  'all',
  'https://ocdipl.sharepoint.com/sites/1Cell.AiMarketingSite/Shared%20Documents/Corporate/1Cell_Laboratory_Quality_Manual.pdf',
  'Shared Documents/Corporate/Quality',
  'Quality Assurance Board',
  'team@1cell.ai',
  '2026-03-15T00:00:00.000Z',
  '2026-09-08T00:00:00.000Z',
  FALSE,
  '{"size": "4.2 MB", "downloadCount": 150, "viewCount": 380, "isPinned": false, "isTrending": false, "year": "2026"}'::jsonb
) on conflict (id) do update set
  title = excluded.title,
  description = excluded.description,
  sharepoint_url = excluded.sharepoint_url,
...
insert into public.content_assets (
  ...
  'doc-106',
  '1Cell.Ai Corporate Fact Sheet & Clinical Publications Index',
  'Consolidated index of peer-reviewed clinical publications, international congress presentations (ASCO, SABCS, ESMO), and key performance metrics for healthcare partners.',
  'company-assets',
  'Medical',
  'company',
  'Two Pager',
  ...
  'scientific',
  'all',
  'https://ocdipl.sharepoint.com/sites/1Cell.AiMarketingSite/Shared%20Documents/Corporate/1Cell_FactSheet_Publications_Index.pdf',
  'Shared Documents/Corporate',
  ...
  '2026-09-08T00:00:00.000Z',
  FALSE,
  '{"size": "2.3 MB", "downloadCount": 210, "viewCount": 520, "isPinned": false, "isTrending": false, "year": "2026"}'::jsonb
) on conflict (id) do update set
  title = excluded.title,
  description = excluded.description,
  sharepoint_url = excluded.sharepoint_url,
